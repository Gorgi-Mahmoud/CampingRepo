 ...
 */
final class Version20210310221845 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reponse_like (id INT AUTO_INCREMENT NOT NULL, reponse_id INT DEFAULT NULL, INDEX IDX_900809F0CF18BB82 (reponse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
