...
class __TwigTemplate_deddf9656aa9d020bb432da850fc6b2309185bdb34f0494221339a829d00815a extends Template
{
    private $source;
    private $macros = [];
...
<button class=\"btn\">";
        // line 4
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 4, $this->source); })()), "Publier")) : ("Publier")), "html", null, true);
        echo "</button>
";
        // line 5
...
{{ form_end(form) }}", "categorie/_form.html.twig", "C:\\Users\\Admin\\Desktop\\integrationfinalpi\\mydir\\templates\\categorie\\_form.html.twig");
    }
}
