...
class __TwigTemplate_e560e6244888277a0ecf72d404913141ed60059e4bdfdf3206e9f94209a72065 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["Blog"]) || array_key_exists("Blog", $context) ? $context["Blog"] : (function () { throw new RuntimeError('Variable "Blog" does not exist.', 21, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["s"]) {
            // line 22
            echo "        <tr>
            <th scope=\"row\">";
            // line 23
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["s"], "id", [], "any", false, false, false, 23), "html", null, true);
            echo "</th>
            <td>";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["s"], "titre", [], "any", false, false, false, 24), "html", null, true);
            echo "</td>
            <td>";
            // line 25
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["s"], "tags", [], "any", false, false, false, 25), "html", null, true);
            echo "</td>
            <td><a href=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("updateblog", ["id" => twig_get_attribute($this->env, $this->source, $context["s"], "id", [], "any", false, false, false, 26)]), "html", null, true);
            echo "\">Modifer</a></td>
            <td><a href=\"/b/d/";
            // line 27
...
";
    ...
    {
        return array (  163 => 30,  154 => 27,  150 => 26,  146 => 25,  142 => 24,  138 => 23,  135 => 22,  131 => 21,  117 => 9,  107 => 8,  95 => 6,  89 => 4,  79 => 3,  60 => 2,  37 => 1,);
    }
...
<table class=\"table\">
    ...
    {% for s in Blog %}
        <tr>
            ...
            <td>{{ s.titre }}</td>
            <td>{{ s.tags }}</td>
            <td><a href=\"{{ path('updateblog',{ 'id': s.id }) }}\">Modifer</a></td>
            <td><a href=\"/b/d/{{ s.id }}\">Supprimer</a></td>
        </tr>
    {% endfor %}
    </tbody>
</table>
