...
class __TwigTemplate_cddc3f8ad81444b631d34575e2babafa24f22f8dbbed46f66643cd3ac3a34fd3 extends Template
{
    private $source;
    private $macros = [];
...
<div>
    <button class=\"btn\">";
        // line 6
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 6, $this->source); })()), "Pay Order At Delivery")) : ("Pay Order At Delivery")), "html", null, true);
        echo "</button>
    <a class=\"btn\" href=";
        // line 7
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("payonline");
        echo ">Pay Order Online</a>
</div>
...
<div>
    <button class=\"btn\">{{ button_label|default('Pay Order At Delivery') }}</button>
    <a class=\"btn\" href={{ path('payonline') }}>Pay Order Online</a>
</div>

{{ form_end(form) }}
", "commande/_form.html.twig", "C:\\Users\\21624\\Downloads\\integrationfinalpi\\mydir\\templates\\commande\\_form.html.twig");
    }
}
