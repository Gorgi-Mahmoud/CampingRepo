...
class __TwigTemplate_1fc90ecd85121bd387430d386dc72fbfe36219278d5dde971dba17c72f4cd102 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("front.html.twig", "categorie/show.html.twig", 1);
    ...
    <table class=\"table\">
        <tbody>
            ...
            <tr>
                ...
                <td>";
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 12, $this->source); })()), "nameCategorie", [], "any", false, false, false, 12), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  95 => 21,  90 => 19,  85 => 17,  77 => 12,  68 => 5,  58 => 4,  35 => 1,);
    }
...
{% block body3 %}
    ...
    <a href=\"{{ path('categorie_index') }}\">Afficher la liste</a>
...
", "categorie/show.html.twig", "C:\\Users\\Admin\\Desktop\\integrationfinalpi\\mydir\\templates\\categorie\\show.html.twig");
    }
}
