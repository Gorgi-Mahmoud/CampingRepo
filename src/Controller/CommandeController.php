...

{
     ...
     */
    public function checkout(SessionInterface $sessionn) {
        $sessionn->start();
        $x =((float)$sessionn->get('total'));
 ...
 */
     ...
     */
    public function new (Request $request, \Swift_Mailer $mailer,$id,SessionInterface $session) :Response
    {
        $session->start();
        $commande = new Commande();
        $commande->setPrixtot((float)$session->get('total'));
        $commande->setMail($this->getUser()->getUsername());
