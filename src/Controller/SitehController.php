...
class SitehController extends AbstractController
{
     ...
     */
    public function searchSiteh(Request $request, NormalizerInterface $Normalizer)
    {
        $repository = $this->getDoctrine()->getRepository(Siteh::class);
        $requestString=$request->get('searchValue');
        $siteh = $repository->findSitehByPlace($requestString);
        $jsonContent = $Normalizer->normalize($gmuses, 'json',['groups'=>'siteh']);
